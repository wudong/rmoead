...
void diff_evo_xover_1(ChromosomePtr base, ChromosomePtr ind1, ChromosomePtr ind2,
...
void diff_evo_xover_2(ChromosomePtr base, ChromosomePtr ind1, ChromosomePtr ind2,
...
void partical_swarm_evol(ChromosomePtr current, ChromosomePtr best, ChromosomePtr local, double* direction){
	double c=2;
